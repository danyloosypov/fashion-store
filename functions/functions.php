<?php
	...
	function getPro() {
		...
		$sql = "Select distinct(product_title), product_id, product_price, product_img1 from products where product_id in (Select product_id from in_stock where quantity > 0) order by 2 desc limit 0,8";
		...
		while($row = mysqli_fetch_array($res)) {
			...
			$p_cat_title = $row['p_cat_title'];
				...
				echo "
					...
					<li style='background:#ddd' class='checkbox checkbox-primary selected '>
						<a href='shop.php?p_cat=$p_cat_id'>
							<label>
								<input type='checkbox' value='$p_cat_id' class='checkbox'> <span> $p_cat_title </span>
							</label>
						</a>
					</li>
				";
			...
			echo "
				...
				<li style='background:#ddd' class='checkbox checkbox-primary'>
					<a href='shop.php?cat=$cat_id'>
						<label>
							<input type='checkbox' value='$cat_id' class='checkbox'> <span> $cat_title </span>
						</label>
					</a>
				</li>
			";
